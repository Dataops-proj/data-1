...
try:
	...
	df.write.format('jdbc').mode('overwrite').option('url', 'jdbc:postgresql://dataopsmariadb.cr5bcibr4zvb.ap-south-1.rds.amazonaws.com:3306/dataops').option('driver', 'org.postgresql.Driver').option('dbtable', 'full_db_test').option('user', username_t).option('password', password_t).save()
