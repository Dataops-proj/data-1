...
try:
	...
	df.write.format('jdbc').mode('overwrite').option('url', 'jdbc:postgresql://dataops-db.cr5bcibr4zvb.ap-south-1.rds.amazonaws.com:5432/postgres').option('dbtable', 'us09').option('user', username_t).option('password', password_t).save()
