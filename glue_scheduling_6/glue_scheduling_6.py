...
try:
	url = base64.b64decode(f'{url}').decode('utf-8')
	token = base64.b64decode(f'{token}').decode('utf-8')
	...
	client = hvac.Client(url='aHR0cDovLzMuNi40MC4yMzE6ODIwMA==', token='cy54UGtIemZON2p4cHliNW9BR0JxeDRXSUM=')
